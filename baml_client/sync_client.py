...
class BamlStreamClient:
    ...
    def ClassifyImage(
        ...
        img: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[Optional[types.ImageClass], types.ImageClass]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[Optional[types.ImageClass], types.ImageClass](
        raw,
        lambda x: cast(Optional[types.ImageClass], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.ImageClass, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
